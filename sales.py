...
def show_header():
    st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Welcome to Nishan Sales Dashboard</h1>", unsafe_allow_html=True)
    st.markdown("---")

# Function to show footer
def show_footer():
    st.markdown("---")
    st.markdown("<p style='text-align: center; font-size:12px; color:gray;'>© 2025 Nishan Sales. All rights reserved.</p>", unsafe_allow_html=True)

# PDF export helper functions (your existing code)
...
# Sales tracking page code
def sales_tracking_page():
...
def main():
    ...
    page = st.sidebar.radio("Go to", ["Home", "Sales Tracking"])

    if page == "Home":
        st.markdown("<h2 style='text-align:center;'>Welcome to Nishan Sales Dashboard!</h2>", unsafe_allow_html=True)
        st.markdown("<p style='text-align:center;'>Use the sidebar to navigate to the Sales Tracking page.</p>", unsafe_allow_html=True)
